...
export default class LWCLookup extends LightningElement {
    ...
    @track listClass = 'slds-dropdown slds-dropdown_length-with-icon-7 slds-dropdown_fluid';
    ...
    @wire(lookUp, { searchTerm: '$searchTerm', objectName: '$objName', filters: '$filters', fields: '$displayFields', searchField: '$searchField' })
    ...
    handleClick() {
        ...
        this.listClass = 'slds-dropdown slds-dropdown_length-with-icon-7 slds-dropdown_fluid'; 
    }
    ...
    onblured(){
        console.log('text');
        //this.listClass = 'slds-dropdown slds-dropdown_length-with-icon-7 slds-dropdown_fluid slds-hide'; 
    }
